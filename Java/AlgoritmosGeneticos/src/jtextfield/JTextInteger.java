...
public class JTextInteger extends JTextField implements KeyListener, FocusListener {
	...
	public JTextInteger(int tamano) {
		super(tamano);
		this.tamano = tamano;
		addKeyListener(this);
	...
	public JTextInteger(int tamano, boolean negativos) {
		super(tamano);
		this.tamano = tamano;
	...
	public int getValor() {
		...
		return Integer.parseInt(quitaComas(getText()));
	}
